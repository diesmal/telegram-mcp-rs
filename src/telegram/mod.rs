...
pub trait MessageService {
    ...
    async fn search_messages(&self, peer_id: i64, query: &str, limit: i32, from_user_id: Option<i64>, from_username: Option<String>, offset_id: Option<i32>, min_date: Option<i32>, max_date: Option<i32>, filter: Option<String>) -> Result<Vec<MessageInfo>>;
    async fn search_global_messages(&self, query: &str, limit: i32, offset_id: Option<i32>, min_date: Option<i32>, max_date: Option<i32>, filter: Option<String>) -> Result<Vec<MessageInfo>>;
